...
module.exports = {
    ...
    deleteServer: function (srv_id, callback) {
        req.is_del(["servers", srv_id], callback)
    },
    ...
    deleteIp: function (srv_id, ip_id, callback) {
        req.is_del(["servers", srv_id, "ips", ip_id], callback)
    },
    ...
    listPrivateNetworks: function (srv_id, callback) {
        req.is_get(["servers", srv_id, "private_networks"], callback)
    },

    assignPrivateNetwork: function (srv_id, json, callback) {
        req.is_post(["servers", srv_id, "private_networks"], json, callback)
    },

    deletePrivateNetwork: function (srv_id, private_network_id, callback) {
        req.is_del(["servers", srv_id, "private_networks", private_network_id], callback)
    },

    getPrivateNetwork: function (srv_id, private_network_id, callback) {
    ...
    createSnapshot: function (srv_id, json, callback) {
        req.is_post(["servers", srv_id, "snapshots"], json, callback)
    },

    restoreSnapshot: function (srv_id, snapshot_id, json, callback) {
        req.is_put(["servers", srv_id, "snapshots", snapshot_id], json, callback)
    },
