 ...
 */
module.exports = {
    endPointPath: "monitoring_center",

    listMonitorinCenters: function (callback) {
        req.is_get([this.endPointPath], callback)
    },
    listMonitorinCentersWithOption: function (options, callback) {
    ...
    getServerMonitoringCenterFixedPeriod: function (srv_id, period, callback) {
        ...
        req.is_get([this.endPointPath, srv_id, path], callback)
    },
